...
export const PrevArrow = ({prev, ...rest}:any)=>{
    return <Button borderRadius='full' p='0' _hover={{bg:'white'}} onClick={()=>prev()} color='purple.500' w={{base:'40px',lg:'56px'}} h={{base:'40px',lg:'56px'}} bg='white' boxShadow= '0px 3px 6px 0px #8E72FF4D'
