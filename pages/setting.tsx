      ...
      <Container maxW={{ sm: 'xl', md: '3xl', lg: '5xl', xl: '7xl' }}>
        <Box mt='24px'>
          <Tabs>
            ...
            <TabPanels>
              <TabPanel p={0}>
                <Box mt='15px' px={{ base: '0', md: '17px' }} mb='85px'>
                  <ProfileHeader showSocialIcons={false} />
                </Box>
                <Container maxW={{ sm: '2xl', md: '3xl', lg: '4xl', xl: '5xl' }} p={{ base: '0', md: '16px' }}>
                  <Box>
                    <FormControl>
                      <Flex mb='24px' gap={{ base: '0', sm: '2', md: '6' }} display={{ base: 'block', sm: 'flex' }} justifyContent={{ base: 'initial', sm: 'space-between', xl: 'space-between' }}>

                        <Box w={{ base: '100%', md: 'md' }} mb={{base:'24px',md:'0'}}>
                          <FormLabel fontSize='16px' fontWeight='500' mb='16px'>Display Name</FormLabel>
                      ...
                      <Stack mb='24px'>
                        <Text fontSize='16px' fontWeight='500' mb='16px'>Short Bio</Text>
                      ...
                      <Flex mb='24px' gap={{ base: '0', sm: '2', md: '6' }} display={{ base: 'block', sm: 'flex' }} justifyContent={{ base: 'initial', sm: 'space-between', xl: 'space-between' }}>
                        ...
                        <Stack w={{ base: '100%', md: 'md' }}  mb={{base:'24px',md:'0'}}>
                          <FormLabel fontSize='16px' fontWeight='500' mb='16px'>Email</FormLabel>
                      ...
                      <Flex mb='24px' gap={{ base: '0', sm: '2', md: '6' }} display={{ base: 'block', sm: 'flex' }} justifyContent={{ base: 'initial', sm: 'space-between', xl: 'space-between' }}>
                        ...
                        <Box w={{ base: '100%', md: 'md' }}>
                          <FormLabel fontSize='16px' fontWeight='500' mb='16px'>Etherscan</FormLabel>
                      ...
                      <Box mb='24px'>
                        ...
                        <Box>
                          <Flex mb='24px' columnGap={'20'} flexDirection={{ base: 'column', md: 'row' }} justifyContent={{ base: 'initial', sm: 'space-between' }}>
                            <Box w='100%' display='flex' p={{ base: '16px', md: '16px 32px' }} justifyContent='space-between' alignItems='center' bg='rgba(104, 99, 243, 0.1)' boxShadow='2px 2px 8px rgba(13, 13, 13, 0.1)' borderRadius='lg' border='1px solid rgba(111, 107, 243, 0.4)' mb={{ base: '24px', md: '0' }}>
                            <Flex display='flex' alignItems='center'>
                              ...
                              <Button ml='auto' p={{ base: '12px 16px', md: '20px 32px' }} variant='primary'>Disconnect</Button>
                            </Box>
                            <Box w='100%' display='flex' p={{ base: '16px', md: '16px 32px' }} justifyContent='space-between' alignItems='center' bg='rgba(104, 99, 243, 0.1)' boxShadow='2px 2px 8px rgba(13, 13, 13, 0.1)' borderRadius='lg' border='1px solid rgba(111, 107, 243, 0.4)'>
                              <Flex display='flex' alignItems='center'>
                                <Box color=' #6863F3' fontSize='20px' mr={{ base: '8px', md: '16px' }}>
                                  <i className="icon-instagram"></i>
                                </Box>
                          ...
                          <Flex mb='24px' columnGap={'20'} display={{ base: 'block', md: 'flex' }} justifyContent={{ base: 'initial', sm: 'space-between' }}>
                            <Box w='100%' display='flex' p={{ base: ' 16px', md: '16px 32px' }} justifyContent='space-between' alignItems='center' bg='#fff' boxShadow='2px 2px 8px rgba(13, 13, 13, 0.1)' borderRadius='lg' border='1px solid rgba(111, 107, 243, 0.4)' mb={{ base: '24px', md: '0' }}>
                              <Flex display='flex' alignItems='center'>
                              ...
                              <Button ml='auto' p={{ base: '12px 16px', md: '20px 32px' }} variant='primary'>Connect</Button>
                            </Box>

                            <Box w='100%' display='flex' p={{ base: '16px', md: '16px 32px' }} justifyContent='space-between' alignItems='center' bg='#fff' boxShadow='2px 2px 8px rgba(13, 13, 13, 0.1)' borderRadius='lg' border='1px solid rgba(111, 107, 243, 0.4)'>
                              <Flex display='flex' alignItems='center'>
                                <Box color=' #393F59' fontSize='20px' mr={{ base: '8px', md: '16px' }}>
                                  <i className="icon-instagram"></i>
                                </Box>
                          ...
                          {/* <Flex mb='24px' columnGap={'20'} display={{ base: 'block', sm: 'flex' }} justifyContent={{ base: 'initial', sm: 'space-between' }}>
                            <Box w='50%' display='flex' p='16px 32px' justifyContent='space-between' alignItems='center' bg='rgba(104, 99, 243, 0.1)' boxShadow='2px 2px 8px rgba(13, 13, 13, 0.1)' borderRadius='lg' border='1px solid rgba(111, 107, 243, 0.4)'>
                              <Checkbox size="xl" colorScheme="transparent"><i className='icon-twitter'></i>Themed Red XL Circular Checkbox<label>Disconnect</label></Checkbox>
                            </Box>
                          </Flex> */}
