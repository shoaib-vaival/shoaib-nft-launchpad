                    ...
                    <FormControl>
                      ...
                      <Box mb='24px'>
                        ...
                        <Box>
                          ...
                          <Box w='100%' display='flex' p={{ base: '16px', md: '24px 32px' }} justifyContent='space-between' alignItems='center' bg='rgba(104, 99, 243, 0.1)' boxShadow='2px 2px 8px rgba(13, 13, 13, 0.1)' borderRadius='lg' border='1px solid rgba(111, 107, 243, 0.4)' mb={{ base: '24px', md: '0' }}>
                              ...
                              <FormLabel htmlFor='label' border='1px solid #6863F3' borderRadius='8px' bg='purple.500' color='white' pointerEvents='painted' p={{ base: '12px 16px', md: '12px 32px' }}>
                                <Checkbox id='label' color='white' display='none'></Checkbox>
                                Disconnect
                              </FormLabel>
                            </Box>
                            <Box w='100%' display='flex' p={{ base: ' 16px', md: '24px 32px' }} justifyContent='space-between' alignItems='center' bg='#fff' boxShadow='2px 2px 8px rgba(13, 13, 13, 0.1)' borderRadius='lg' border='1px solid rgba(111, 107, 243, 0.4)' mb={{ base: '24px', md: '0' }}>
                              <Flex display='flex' alignItems='center'>
